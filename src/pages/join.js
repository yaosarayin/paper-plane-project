...
const Join = () => {
  return (
    <Layout>
      ...
      世界卫生组织的官网上显示，每四人中就有一人患有某种心理健康疾病。心理健康问题出没在中国与全球的每个角落，但只有少数人愿意去帮助心理健康问题患者，了解心理健康背后的知识。 也只有少数人意识到，我们应该像关心自己的身体一样时刻关注自己的心理状态，并照顾家人朋友的心理状态。其实，每个人需要的仅仅是一个会倾听的人和一个安全的，说什么心理话都可以的环境。但根深蒂固的社会偏见让这样的环境愈发难以形成。纸飞机希望能够做些什么，改变这个现状。
      ...
      <p>
      需要更多加入我们的理由？那好吧。加入纸飞机的话，你可以...
      </p>
      <ul>
      <li>为申请海外大学加分！因为你在帮助你的社区、在make a real difference！</li>
      <li>完成学校的Community Service Requirement或者CAS</li>
      <li>收货与一只哈佛创新实验室团队一起工作的经验</li>
      <li>拥有一个更大的平台，分享你的心理健康经历或任何想说的话</li>
      <li>在为新文章做调查研究、修改他人书写的段落、设计下一张封面图的过程中学到新的知识或提升原油的技能</li>
      <li>认识团队中其他的青少年，结交新的朋友</li>认识团队中其他的青少年，结交新的朋友
      </ul>
